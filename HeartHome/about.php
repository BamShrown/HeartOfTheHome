...
?>
    ...
    <section class="pagetrustpoints fadeup">
        <div class="container py-3">
            <div class="row">
                <?php
                    if( get_field('trustpoint1') ): ?>
                    <div class="fadeup col-6 col-lg-3 text-left d-flex justify-content-center align-items-center my-3">
    ...
    <div class="w-100 d-flex fadeup flex-column flex-md-row">
        <div class="d-flex justify-content-end w-100 w-md-50">
